...
public class PGEExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    static HashMap< java.lang.String,java.lang.Class> classNames = new HashMap< java.lang.String, java.lang.Class>();
    static {
        classNames.put("http://web/^^sessionResponse",PGEsessionResponse.class);
        classNames.put("http://web/^^returnCodeResponse",PGEreturnCodeResponse.class);
        classNames.put("http://web/^^dataTransferObject",PGEdataTransferObject.class);
        classNames.put("http://web/^^sessionData",PGEsessionData.class);
        classNames.put("http://web/^^userData",PGEuserData.class);
        classNames.put("http://web/^^meetsResponse",PGEmeetsResponse.class);
        classNames.put("http://web/^^meet",PGEmeet.class);
        classNames.put("http://web/^^user",PGEuser.class);
        classNames.put("http://web/^^category",PGEcategory.class);
        classNames.put("http://web/^^meetResponse",PGEmeetResponse.class);
        classNames.put("http://web/^^categoriesResponse",PGEcategoriesResponse.class);
    }   

    protected static final int QNAME_NAMESPACE = 0;
    private static final String TYPE_LABEL = "type";

    public PGEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PGEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PGEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            ...
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=PGEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public java.lang.Object get(java.lang.Object soap,java.lang.Class cl)
    {
        ...
        try
        {
            ...
            {
                Constructor ctor = cl.getConstructor(java.lang.Object.class,PGEExtendedSoapSerializationEnvelope.class);
